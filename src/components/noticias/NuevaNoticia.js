            ...
            <Form ref={formRef} className='mx-5' onSubmit={handleSubmit}>
                ...
                <Form.Row>
                    <Form.Group className='col-sm-12 col-md-8'>
                        ...
                        <Form.Control className="outlineColor" as="textarea" row={3} placeholder="Imágen Principal" onChange={(e) => setImagenPrincipal(e.target.value)} required />
                    </Form.Group>
                ...
                <Form.Row>
                    <Form.Group className='col-sm-12 col-md-8'>
                        ...
                        <Form.Control className="outlineColor" as="textarea" row={3} placeholder="Imágen Secundaria" onChange={(e) => setImagenSec(e.target.value)} />
                    </Form.Group>
                    <Form.Group className='col-sm-12 col-md-4 align-self-center d-flex justify-content-center'>
