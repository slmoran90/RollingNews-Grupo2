...
const EditarNoticia = () => {
    ...
    console.log('parametro de noticia:',useParams().id);
            ...
            <Form className="mx-5">
                <Form.Row>
                    <Form.Group className="col-sm-6 col-md-4">
                        ...
                        <Form.Control
                            ...
                            defaultValue={noticiaCompleta.categoria}
                            disabled
                        />
                    </Form.Group>
                    <Form.Group className="col-sm-6 col-md-4">
                    ...
                    <Form.Group className="col-sm-6 col-md-4">
                        ...
                        <Form.Control
                            ...
                            size="sm"
                            placeholder="Autor"
                            defaultValue={noticiaCompleta.autorNoticia}
                            disabled
                        />
                    </Form.Group>
                </Form.Row>
                ...
                <Form.Group>
                    ...
                    <Form.Control
                        ...
                        defaultValue={noticiaCompleta.tituloNoticia}
                        disabled
                    />
                </Form.Group>
                ...
                <Form.Group>
                    ...
                    <Form.Control
                        ...
                        defaultValue={noticiaCompleta.noticiaBreve}
                        disabled
                    />
                </Form.Group>
                ...
                <Form.Group>
                    ...
                    <Form.Control
                        ...
                        defaultValue={noticiaCompleta.noticiaDetallada}
                        disabled
                    />
                </Form.Group>
                ...
                <Form.Row>
                    <Form.Group className="col-sm-12 col-md-8">
                        ...
                        <Form.Control
                            ...
                            defaultValue={noticiaCompleta.imagenPrincipal}
                            disabled
                        />
                    </Form.Group>
                    ...
                    <Form.Group className="col-sm-12 col-md-4 align-self-center d-flex justify-content-center">
                        <img
                            className="w-75"
                            src={noticiaCompleta.imagenPrincipal}
                ...
                <Form.Row>
                    <Form.Group className="col-sm-12 col-md-8">
                        ...
                        <Form.Control
                            ...
                            defaultValue={noticiaCompleta.imagenSec}
                            disabled
                        />
                    </Form.Group>
                ...
                <Form.Group className="my-2 pb-2">
                    <Form.Check
                        ...
                        defaultValue={noticiaCompleta.destacada}
                        disabled
                    />
                </Form.Group>

                <Link
                    className="btn btn-primary text-light mr-3 d-block"
                    to={"/noticias/listar/" + noticiaCompleta.categoria}
                >
                    {" "}
          Volver a Noticias por Categoría
        </Link>
            </Form>
        </Container>
